    ...
    <table class="table table-bordered mt-4">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="nome" name="nome" placeholder="Marcelo Junior">
        </div>
      </div>
      <div class="form-group">
        <label>Endereço</label>
        <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Rua exemplo 1">
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label>Telefone</label>
          <input type="text" class="form-control" id="telefone" name="telefone" placeholder="9 9999-9999">
        </div>
        <div class="form-group col-md-6">
          <label>Cidade</label>
          <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Toledo">
        </div>
      </div>
      ...
      <input type="hidden" name="venda" id="venda" value="venda">
      <input type="submit" value="Fechar venda" name="enviar" id="enviar" class="btn btn-dark" style="padding: 5px 25px; border-radius:0px;">
